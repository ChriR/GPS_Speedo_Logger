...
#define MMC_CD		getSDCD()	/* Card detected.   yes:true, no:false, default:true */
...
{
#ifndef SDCARD_OFF
	SPI_reserve(getSDSPIProcess());
	return SPI_xchg(getSDSPIProcess(), dat);
#else
	return 0xFF;
#endif
}
...
{
#ifndef SDCARD_OFF
	SPI_xmit(getSDSPIProcess(), cnt, p);	
...
{
#ifndef SDCARD_OFF
	SPI_DeselectCS(getSDSPIProcess());		/* Set CS# high */
...
{
#ifndef SDCARD_OFF
	SPI_SelectCS(getSDSPIProcess());	/* Set CS# low */
...
DWORD get_fattime (void)
{
	return sd_fattime();
    /*
	return  ((2016UL-1980) << 25) |		// Year = 2007
            (3UL << 21) |				// Month = June
            (23UL << 16) |				// Day = 5
            (14U << 11) |				// Hour = 11
            (00U << 5) |				// Min = 38
